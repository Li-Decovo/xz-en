...
$fields = [
    ...
    ['key' => 'field_xz_product_card_finished_image', 'label' => 'Product Card Finished Products Image', 'name' => 'product_card_finished_image', 'type' => 'image', 'menu_order' => 4, 'return_format' => 'id', 'preview_size' => 'medium', 'library' => 'all', 'min_width' => '', 'min_height' => '', 'min_size' => '', 'max_width' => '', 'max_height' => '', 'max_size' => '', 'mime_types' => ''],
    ['key' => 'field_xz_product_key_parameters', 'label' => 'Key Parameters', 'name' => 'product_key_parameters', 'type' => 'repeater', 'menu_order' => 5, 'layout' => 'table', 'button_label' => 'Add Parameter', 'min' => 0, 'max' => 0, 'collapsed' => ''],
    ['key' => 'field_xz_product_tab_overview', 'label' => 'Overview', 'name' => '', 'type' => 'tab', 'menu_order' => 6, 'placement' => 'top', 'endpoint' => 0],
    ['key' => 'field_xz_product_overview_primary', 'label' => 'Overview Primary Content', 'name' => 'product_overview_primary', 'type' => 'wysiwyg', 'menu_order' => 7, 'default_value' => '', 'tabs' => 'all', 'toolbar' => 'full', 'media_upload' => 1, 'delay' => 0],
    ['key' => 'field_xz_product_overview_image', 'label' => 'Overview Image', 'name' => 'product_overview_image', 'type' => 'image', 'menu_order' => 8, 'return_format' => 'id', 'preview_size' => 'medium', 'library' => 'all', 'min_width' => '', 'min_height' => '', 'min_size' => '', 'max_width' => '', 'max_height' => '', 'max_size' => '', 'mime_types' => ''],
    ['key' => 'field_xz_product_overview_video_url', 'label' => 'Overview Video URL', 'name' => 'product_overview_video_url', 'type' => 'url', 'menu_order' => 9, 'default_value' => '', 'placeholder' => ''],
    ['key' => 'field_xz_product_overview_secondary', 'label' => 'Overview Secondary Content', 'name' => 'product_overview_secondary', 'type' => 'wysiwyg', 'menu_order' => 10, 'default_value' => '', 'tabs' => 'all', 'toolbar' => 'full', 'media_upload' => 1, 'delay' => 0],
    ['key' => 'field_xz_product_tab_specs', 'label' => 'Technical Specifications', 'name' => '', 'type' => 'tab', 'menu_order' => 11, 'placement' => 'top', 'endpoint' => 0],
    ['key' => 'field_xz_product_specifications', 'label' => 'Technical Specifications', 'name' => 'product_specifications', 'type' => 'wysiwyg', 'menu_order' => 12, 'default_value' => '', 'tabs' => 'all', 'toolbar' => 'full', 'media_upload' => 1, 'delay' => 0],
    ['key' => 'field_xz_product_tab_finished', 'label' => 'Finished Products', 'name' => '', 'type' => 'tab', 'menu_order' => 13, 'placement' => 'top', 'endpoint' => 0],
    ['key' => 'field_xz_product_finished_products', 'label' => 'Finished Products', 'name' => 'product_finished_products', 'type' => 'gallery', 'menu_order' => 14, 'return_format' => 'id', 'preview_size' => 'medium', 'insert' => 'append', 'library' => 'all', 'min' => '', 'max' => '', 'min_width' => '', 'min_height' => '', 'min_size' => '', 'max_width' => '', 'max_height' => '', 'max_size' => '', 'mime_types' => ''],
    ['key' => 'field_xz_product_tab_faq', 'label' => 'FAQ', 'name' => '', 'type' => 'tab', 'menu_order' => 15, 'placement' => 'top', 'endpoint' => 0],
    ['key' => 'field_xz_product_faq', 'label' => 'Frequently Asked Questions', 'name' => 'product_faq', 'type' => 'repeater', 'menu_order' => 16, 'layout' => 'block', 'button_label' => 'Add FAQ', 'min' => 0, 'max' => 0, 'collapsed' => 'field_xz_faq_question'],
    ['key' => 'field_xz_product_tab_related', 'label' => 'Related Products', 'name' => '', 'type' => 'tab', 'menu_order' => 17, 'placement' => 'top', 'endpoint' => 0],
    ['key' => 'field_xz_related_products', 'label' => 'Related Products', 'name' => 'related_products', 'type' => 'relationship', 'menu_order' => 18, 'post_type' => ['product'], 'post_status' => ['publish'], 'taxonomy' => '', 'filters' => ['search', 'taxonomy'], 'return_format' => 'id', 'min' => '', 'max' => '', 'elements' => ''],
];
