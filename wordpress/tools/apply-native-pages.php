...
$contact = [
    xznp_container('ctroot01', 'xz-contact-page contact-main', [
        xznp_widget('cthero01', 'xinzhou-contact-hero', ['title' => 'Discuss Your Welding Equipment Project with Our Team', 'description' => 'Share your finished product, production capacity, factory layout and technical requirements. Our sales and engineering teams will help define the next practical step.', 'image' => xznp_media_setting('https://darkturquoise-camel-554606.hostingersite.com/wp-content/uploads/2026/07/contact-hero-factory.webp')]),
        xznp_widget('ctinq001', 'xinzhou-contact-inquiry', ['eyebrow' => 'Start a Conversation', 'title' => 'Contact Our Sales Team', 'intro' => 'Tell us what you plan to produce and the support you need. More complete product and factory information helps our team prepare a more accurate response.', 'email' => 'xinzhou@weldercn.com', 'phone' => '+86 180 6723 1686', 'office' => 'Ningbo, Zhejiang, China', 'note_title' => 'Project Information', 'note_copy' => 'Product drawings, sample photos, material specifications and target output are helpful for technical evaluation.', 'linkedin' => ['url' => 'https://www.linkedin.com/company/xinzhouwelding'], 'facebook' => ['url' => 'https://www.facebook.com/xinzhouwelder'], 'tiktok' => ['url' => 'https://www.tiktok.com/@xinzhouwelder'], 'form_label' => 'Equipment Inquiry', 'form_title' => 'Tell Us What You Need to Produce', 'form_id' => 1]),
        xznp_widget('ctproc01', 'xinzhou-contact-process', ['eyebrow' => 'How We Support', 'title' => 'A Clear Start for Your Equipment Project', 'steps' => [['_id' => 'ctstep01', 'icon' => ['value' => 'far fa-file-alt', 'library' => 'fa-regular'], 'title' => 'Share Your Requirement', 'description' => 'Send the finished product, specifications, target output and available factory information.'], ['_id' => 'ctstep02', 'icon' => ['value' => 'fas fa-sitemap', 'library' => 'fa-solid'], 'title' => 'Plan the Right Solution', 'description' => 'Our sales and engineering teams review machine selection, configuration and production line layout.'], ['_id' => 'ctstep03', 'icon' => ['value' => 'far fa-comments', 'library' => 'fa-regular'], 'title' => 'Continue Technical Discussion', 'description' => 'Confirm specifications, quotation, layout and service requirements before the project moves forward.']]]),
        xznp_widget('ctloc001', 'xinzhou-contact-location', ['image' => xznp_media_setting('https://darkturquoise-camel-554606.hostingersite.com/wp-content/uploads/2026/07/contact-factory.webp'), 'eyebrow' => 'Xinzhou Manufacturing Base', 'title' => 'Connected to Manufacturing, Engineering and Global Service', 'description' => 'Xinzhou operates manufacturing facilities in Ningbo and Jiaxing, supported by experienced sales, engineering, assembly and after-sales teams.', 'address' => 'Ningbo, Zhejiang, China']),
    ], [], false),
];
...
xznp_save_page(24, $contact, $contact_css);
