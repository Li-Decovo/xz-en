...
$contact = [
    xznp_container('ctroot01', 'xz-contact-page contact-main', [
        ...
        xznp_widget('ctproc01', 'xinzhou-contact-process', ['eyebrow' => 'How We Support', 'title' => 'A Clear Start for Your Equipment Project', 'steps' => [['_id' => 'ctstep01', 'icon' => 'file', 'title' => 'Share Your Requirement', 'description' => 'Send the finished product, specifications, target output and available factory information.'], ['_id' => 'ctstep02', 'icon' => 'workflow', 'title' => 'Plan the Right Solution', 'description' => 'Our sales and engineering teams review machine selection, configuration and production line layout.'], ['_id' => 'ctstep03', 'icon' => 'message', 'title' => 'Continue Technical Discussion', 'description' => 'Confirm specifications, quotation, layout and service requirements before the project moves forward.']]]),
