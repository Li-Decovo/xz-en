        ...
        <section class="about-factory-section" aria-labelledby="about-factory-title"><div class="xz-container about-factory__layout">
            <div class="about-factory__visual"><div class="about-factory__highlights">
                <?php foreach ((array) ($s['items'] ?? []) as $item) : $image = $this->image_url((array) ($item['image'] ?? [])); ?>
                    <article class="about-factory-highlight"><figure class="about-factory-highlight__media"><?php if ($image) : echo \xz_media_image($image, 'full', ['loading' => 'lazy']); endif; ?></figure><div class="about-factory-highlight__body"><h3><?php echo esc_html((string) ($item['title'] ?? '')); ?></h3></div></article>
                <?php endforeach; ?>
            </div></div>
...
final class About_Quality_Widget extends About_Widget_Base {
    ...
    protected function render(): void {
        ...
        <section class="about-quality-section" aria-labelledby="about-quality-title"><div class="xz-container about-quality__grid">
            ...
            <?php $items = (array) ($s['items'] ?? []); $carousel = count($items) > 1; ?><div class="xz-simple-carousel about-quality-carousel<?php echo $carousel ? ' is-carousel' : ''; ?>"<?php echo $carousel ? ' data-xz-simple-carousel data-visible="2" data-visible-tablet="2" data-visible-mobile="2"' : ''; ?>><?php if ($carousel) : ?><div class="xz-simple-carousel__controls"><button type="button" data-xz-simple-prev aria-label="Previous certificates">&#8249;</button><button type="button" data-xz-simple-next aria-label="Next certificates">&#8250;</button></div><?php endif; ?><div class="about-quality__certificates"<?php echo $carousel ? ' data-xz-simple-track' : ''; ?>><?php foreach ($items as $item) : $image = $this->image_url((array) ($item['image'] ?? [])); ?><article class="about-quality-certificate"><figure class="about-quality-certificate__media"><?php if ($image) : echo \xz_media_image($image, 'large', ['loading' => 'lazy']); endif; ?></figure><div class="about-quality-certificate__body"><h3><?php echo esc_html(wp_strip_all_tags((string) ($item['title'] ?? ''))); ?></h3></div></article><?php endforeach; ?></div></div>
        </div></section>
        <?php
    }
}
...
final class About_Customers_Widget extends About_Widget_Base {
    ...
    protected function render(): void {
        ...
        <section class="about-customers-section" aria-labelledby="about-customers-title"><div class="xz-container about-customers__grid">
            <figure class="about-customers__media"><?php if ($image) : echo \xz_media_image($image, 'full', ['loading' => 'lazy']); endif; ?></figure>
            <div class="about-customers__copy"><p class="about-section-label"><?php echo esc_html((string) ($s['label'] ?? '')); ?></p><h2 id="about-customers-title"><?php echo esc_html((string) ($s['title'] ?? '')); ?></h2><p><?php echo esc_html((string) ($s['description'] ?? '')); ?></p><ul class="about-customers__regions"><?php foreach ((array) ($s['items'] ?? []) as $item) : $flag = $this->image_url((array) ($item['image'] ?? [])); ?><li><?php if ($flag) : echo \xz_media_image($flag, 'full', ['class' => 'about-customers__flag', 'loading' => 'lazy']); endif; ?><strong><?php echo esc_html((string) ($item['title'] ?? '')); ?></strong></li><?php endforeach; ?></ul></div>
        </div></section>
        <?php
    }
}
    ...
    protected function render(): void {
        ...
        <section class="about-timeline-section" aria-labelledby="about-timeline-title"><div class="xz-container"><div class="about-timeline-section__head"><p class="about-section-label"><?php echo esc_html((string) ($s['label'] ?? '')); ?></p><h2 id="about-timeline-title"><?php echo esc_html((string) ($s['title'] ?? '')); ?></h2></div>
            <div class="about-timeline-carousel" data-history-carousel><div class="about-timeline-viewport"><div class="about-timeline-track" data-history-track><?php foreach ((array) ($s['items'] ?? []) as $item) : $image = $this->image_url((array) ($item['image'] ?? [])); ?>
                <article class="about-timeline-card"><div class="about-timeline-card__year"><?php echo esc_html((string) ($item['year'] ?? '')); ?></div><div class="about-timeline-card__node" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M8 2v4"></path><path d="M16 2v4"></path><rect width="18" height="18" x="3" y="4" rx="2"></rect><path d="M3 10h18"></path></svg></div><div class="about-timeline-card__body"><figure class="about-timeline-card__image"><?php if ($image) : echo \xz_media_image($image, 'full', ['loading' => 'lazy']); endif; ?></figure><p><?php echo esc_html((string) ($item['description'] ?? '')); ?></p></div></article>
