...
final class Product_Categories_Widget extends Xinzhou_Widget {
    ...
    protected function render(): void {
        ...
        <<?php echo $archive_layout ? 'section' : 'nav'; ?> class="<?php echo $archive_layout ? 'product-category-nav' : 'xz-product-category-nav xz-product-category-nav--homepage xz-simple-carousel is-carousel'; ?>"<?php echo $archive_layout ? '' : ' data-xz-simple-carousel data-visible="7" data-visible-tablet="5" data-visible-mobile="3"'; ?> aria-label="Product categories">
