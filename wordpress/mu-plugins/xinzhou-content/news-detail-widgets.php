...
final class News_Detail_Hero_Widget extends News_Detail_Widget_Base {
    ...
    protected function render(): void {
        ...
        ?>
        <section class="article-hero" aria-labelledby="article-title"<?php echo $hero_style; ?>><?php if ($image) : echo \xz_media_image($image, 'full', ['class' => 'article-hero__image']); endif; ?><div class="article-hero__overlay"></div><div class="xz-container article-hero__content"><nav class="article-breadcrumb" aria-label="Breadcrumb"><a href="<?php echo esc_url(home_url('/')); ?>">Home</a><span>/</span><a href="<?php echo esc_url($news_page ? get_permalink($news_page) : home_url('/news/')); ?>"><?php echo esc_html((string) ($s['news_label'] ?? 'News')); ?></a><?php if ($category) : ?><span>/</span><span><?php echo esc_html($category->name); ?></span><?php endif; ?></nav><h1 id="article-title"><?php echo esc_html(get_the_title($post_id)); ?></h1></div></section>
        <?php
    }
}
