    ...
    protected function render(): void {
        ...
        <div class="xz-page-header-shell">
            ...
            <header class="xz-page-header"><div class="xz-page-header__inner">
                <a class="xz-page-header__brand" href="<?php echo esc_url(home_url('/')); ?>"><?php if ($logo_id) : echo wp_get_attachment_image($logo_id, 'full'); elseif ($logo_url) : ?><img src="<?php echo esc_url($logo_url); ?>" alt="Xinzhou Automation"><?php endif; ?></a>
